...
<div className="absolute inset-0 z-0 pointer-events-none">
  <div className="max-w-7xl mx-auto px-6 lg:px-8 h-full relative">
    <FaPhoneAlt 
      size={380} 
      className="absolute left-6 lg:-left-2 top-1/2 -translate-y-1/2 text-white opacity-20 -rotate-12" 
    />
  </div>
</div>
              ...
              <div className="relative z-20 space-y-8">
                ...
                <div className="flex gap-4 pt-6 justify-center">
                  {[FaFacebookF, FaTwitter, FaLinkedinIn].map((Icon, i) => (
                    <div key={i} className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center text-white hover:bg-white hover:text-[#004d2c] transition-all cursor-pointer shadow-sm">
                      <Icon size={16} />
                    </div>
                  ))}
                </div>
